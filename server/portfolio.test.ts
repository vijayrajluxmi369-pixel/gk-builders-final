...
describe("Portfolio Gallery", () => {
  ...
  it("should have descriptive captions for all items", () => {
    const portfolioItems = [
      ...
      { caption: "Professional construction expertise with organized site management and quality standards in Rishikesh" },
      { caption: "Modern construction techniques ensuring durability and quality in every phase in Rishikesh" },
      { caption: "High-quality tiles, marble, and bricks trusted by builders across Rishikesh" },
      { caption: "Comprehensive range of durable, premium construction materials for all projects in Rishikesh" },
    ];
  ...
  it("should have unique portfolio item IDs", () => {
    const portfolioItems = [
      { id: "home-1" },
      { id: "home-2" },
      { id: "construction-1" },
